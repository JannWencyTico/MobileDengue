        ...
        <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
            <div class="panel panel-info" >
                <div class="panel-heading">
                    <div class="panel-title"><b>DENGUE 101</b></div>
                </div>     
                <div style="padding-top:30px" class="panel-body" >
                <div style="display:none" id="login-alert" class="alert alert-danger col-sm-12"></div>
                    <form id="loginform" class="form-horizontal" role="form" action="<?php echo base_url();?>index.php/verifylogin" method="post" name="login">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12 control">
                                <div style="float: right; font-size:11px" >
                                    © Department of Health, Davao City, Region XI
                                </div>
                            </div>
                        </div>
                    </form>
