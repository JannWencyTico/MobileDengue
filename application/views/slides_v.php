    ...
    <div class="slider">
        ...
        <div class="Snav">
            ...
            <div id="SnavBottom">
                ...
                <p id="SP2">Search and Destory </p>
                <p id="SP3">Self Protection Measures</p>
                <p id="SP4">Seek Early Consultation</p>
                <p id="SP5">No to Indiscriminate Fogging</p>
                <p id="SP6">The 4 o'clock Habbit</p>
            </div>
        </div>
    </div>
</body>
